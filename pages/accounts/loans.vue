      ...
      <div class="card custom-card loan-card shadow-lg">
        <div class="card-body d-flex align-items-center">
          ...
          <div>
            ...
            <h4 class="fw-semibold mb-1">{{ totalLoan.toLocaleString('fr-FR', { style: 'currency', currency: 'MAD' }) }}</h4>
      ...
      <div class="card custom-card loan-card shadow-lg">
        <div class="card-body d-flex align-items-center">
          ...
          <div>
            ...
            <h4 class="fw-semibold mb-1">{{ remainingBalance.toLocaleString('fr-FR', { style: 'currency', currency: 'MAD' }) }}</h4>
        ...
        <div class="card-body p-0">
          <table class="table text-nowrap table-hover mb-0">
            ...
            <tr v-for="payment in paymentDetails" :key="payment.id">
              ...
              <td>{{ payment.amount.toLocaleString('fr-FR', { style: 'currency', currency: 'MAD' }) }}</td>
