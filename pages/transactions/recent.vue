...
export default {
  setup() {
    ...
    const transactions = ref([
      { id: 1, date: '21/01/2025', description: 'Virement à DE32XX', type: 'Bloqué', amount: -184000 },
      { id: 1, date: '02/10/2024', description: 'Paiement en ligne', type: 'Débit', amount: -500 },
      { id: 2, date: '01/10/2024', description: 'Salaire', type: 'Crédit', amount: 7000 },
      { id: 3, date: '30/09/2024', description: 'Achat Boutique', type: 'Débit', amount: -200 },
      { id: 4, date: '29/09/2024', description: 'Virement', type: 'Crédit', amount: 500 },
      { id: 5, date: '28/09/2024', description: 'Retrait DAB', type: 'Débit', amount: -1000 }
    ]);
